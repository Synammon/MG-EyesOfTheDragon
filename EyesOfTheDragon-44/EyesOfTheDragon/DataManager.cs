...
namespace EyesOfTheDragon.Components
{
    static class DataManager
    {
        ...
        static readonly Dictionary<string, ArmorData> armor = new Dictionary<string, ArmorData>();
        static readonly Dictionary<string, WeaponData> weapons = new Dictionary<string, WeaponData>();
        static readonly Dictionary<string, ShieldData> shields = new Dictionary<string, ShieldData>();
        static readonly Dictionary<string, KeyData> keys = new Dictionary<string, KeyData>();
        static readonly Dictionary<string, ChestData> chests = new Dictionary<string, ChestData>();
        static readonly Dictionary<string, EntityData> entities = new Dictionary<string, EntityData>();
        static readonly Dictionary<string, SkillData> skills = new Dictionary<string, SkillData>();
